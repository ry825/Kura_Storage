...
namespace KuraStorage.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260907102438_RemoveMediaCacheCleanup")]
    partial class RemoveMediaCacheCleanup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KuraStorage.Domain.Activity.UserActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DeleteKind")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("delete_kind");

                    b.Property<Guid?>("DestinationParentId")
                        .HasColumnType("uuid")
                        .HasColumnName("destination_parent_id");

                    b.Property<string>("DestinationParentName")
                        .HasMaxLength(255)
                    ...
                    b.Property<long?>("ResultingFileVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("resulting_file_version");

                    b.Property<string>("ShareAction")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                    ...
                    b.Property<Guid?>("SourceParentId")
                        .HasColumnType("uuid")
                        .HasColumnName("source_parent_id");
                    ...
                    b.HasIndex("DestinationParentId");
            ...
            modelBuilder.Entity("KuraStorage.Domain.Backup.BackupReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("LocalDocumentKey")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
                        .HasColumnName("local_document_key");
                    ...
                    b.Property<long>("RemoteFileVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("remote_file_version");
                    ...
                    b.HasIndex("UserId", "DeviceId", "LocalDocumentKey")
                        .IsUnique()
                        .HasDatabaseName("ux_backup_receipts_user_device_document");

                    b.HasIndex("UserId", "DeviceId", "UpdatedAt")
                        .HasDatabaseName("ix_backup_receipts_compare");

                    b.ToTable("backup_receipts", null, t =>
                        {
                            t.HasCheckConstraint("ck_backup_receipts_remote_version", "\"remote_file_version\" >= 1");

                            t.HasCheckConstraint("ck_backup_receipts_size", "\"size\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("KuraStorage.Domain.Files.FileOperation", b =>
                {
                    ...
                    b.Property<long?>("PreviousFileVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("previous_file_version");
                    ...
                    b.Property<long?>("ResultFileVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("result_file_version");
                    ...
                    b.Property<string>("VersionContentRelativePath")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                        .HasColumnName("version_content_relative_path");

                    b.Property<string>("VersionPublishStage")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("version_publish_stage");

                    b.Property<string>("VersionSha256")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("version_sha256");

                    b.Property<string>("VersionTemporaryRelativePath")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
            ...
            modelBuilder.Entity("KuraStorage.Domain.Files.FileVersionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ContentRelativePath")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                    ...
                    b.HasIndex("FileEntryId", "Version")
                        .IsUnique()
                        .IsDescending(false, true)
                        .HasDatabaseName("ux_file_version_records_file_version");

                    b.HasIndex("FileEntryId", "CreatedAt", "Id")
                        .HasDatabaseName("ix_file_version_records_file_created_id");

                    b.ToTable("file_version_records", null, t =>
                        {
                            t.HasCheckConstraint("ck_file_version_records_sha256_lower_hex", "\"sha256\" ~ '^[0-9a-f]{64}$'");

                            t.HasCheckConstraint("ck_file_version_records_size_bounded", "\"size\" >= 0 AND \"size\" <= 1048576");

                            t.HasCheckConstraint("ck_file_version_records_version_positive", "\"version\" >= 1");
                        });
                });
            ...
            modelBuilder.Entity("KuraStorage.Domain.Transfers.UploadSession", b =>
                {
                    ...
                    b.Property<string>("BackupDecision")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("backup_decision");

                    b.Property<Guid?>("BackupExpectedRemoteFileId")
                        .HasColumnType("uuid")
                        .HasColumnName("backup_expected_remote_file_id");

                    b.Property<long?>("BackupExpectedRemoteFileVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("backup_expected_remote_file_version");

                    b.Property<string>("BackupLocalDocumentKey")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
                        .HasColumnName("backup_local_document_key");

                    b.Property<string>("BackupRelativePath")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                        .HasColumnName("backup_relative_path");

                    b.Property<string>("BackupSourceChecksum")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("backup_source_checksum");

                    b.Property<DateTimeOffset?>("BackupSourceModifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("backup_source_modified_at");
                    ...
                    b.HasIndex("ActorUserId", "DeviceId", "BackupLocalDocumentKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("KuraStorage.Domain.Activity.UserActivity", b =>
                {
                    ...
                    b.HasOne("KuraStorage.Domain.Files.FileEntry", null)
                        .WithMany()
                        .HasForeignKey("DestinationParentId")
                        .OnDelete(DeleteBehavior.SetNull);
