...
enum class ErrorCode {
    ...
    INVALID_FAVORITES_REQUEST,
    TAG_LIMIT_EXCEEDED,
    ENTRY_TAG_LIMIT_EXCEEDED,
    TAG_NOT_FOUND,
    TAG_NAME_CONFLICT,
    ...
    LOSSY_SOURCE_ACKNOWLEDGEMENT_REQUIRED,
    ...
    val category: ErrorCategory
        get() =
            when (code) {
                ...
                ErrorCode.INVALID_ACTIVITY_REQUEST,
                ErrorCode.INVALID_ORGANIZATION_REQUEST,
                ErrorCode.INVALID_FAVORITES_REQUEST,
                ErrorCode.TAG_LIMIT_EXCEEDED,
                ErrorCode.ENTRY_TAG_LIMIT_EXCEEDED,
