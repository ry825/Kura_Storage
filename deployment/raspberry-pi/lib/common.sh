...
load_config() {
    ...
    local required=(
        ...
        KURASTORAGE_MEDIA_VIDEO_CACHE_TTL_HOURS
        ...
        KURASTORAGE_MEDIA_MAXIMUM_CONCURRENT_THUMBNAIL_JOBS
    ...
    ((KURASTORAGE_MEDIA_MAXIMUM_CONCURRENT_THUMBNAIL_JOBS >= 1 && KURASTORAGE_MEDIA_MAXIMUM_CONCURRENT_THUMBNAIL_JOBS <= 8)) ||
        die "Thumbnail concurrency must be between one and eight."
